...
public class PrenotazioneController implements Initializable, DataInitializable<Utente> {
	...
	public void initialize(URL location, ResourceBundle resources) {
		chilometraggioCombo.getItems().addAll(50, 100, 250, 500, 1000);
		prenotaButton.disableProperty().bind(dataRitiroDate.valueProperty().isNull()
	...
	public void scegliVeicoloAction() throws ViewException, BusinessException {
		ViewOrder.addLastView("prenotazione");
		dispatcher.renderView("sceltaVeicolo", utente);
	}

	@FXML
	public void prenotaAction() throws BusinessException, VeicoloNonPrenotabileException {
		...
		double costo = prenotazioneService.calcolaCosto(tariffaScelta, periodo);
		...
		dataRiconsegnaDate.setValue(null);
		chilometraggioCombo.valueProperty().setValue(null);
		prenotazioneLabel.setText("Prenotazione effettuata! Costo: " + costo + " €");
		prenotazioneLabel.setStyle("-fx-border-color: yellow;");
	}

	@FXML
	public void annullaAction() throws BusinessException {
