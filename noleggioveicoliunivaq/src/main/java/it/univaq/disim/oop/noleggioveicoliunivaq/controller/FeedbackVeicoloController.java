...
public class FeedbackVeicoloController implements Initializable, DoubleDataInitializable<Veicolo, Persona> {
	...
	public FeedbackVeicoloController() {
	...
	public void initializeData(Veicolo veicolo, Persona persona) {
		...
		try {
			List<Feedback> feedbacks = feedbackService.visualizzaFeedbacks((Veicolo) veicolo);
